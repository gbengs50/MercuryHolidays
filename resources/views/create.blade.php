...
<head>
<meta charset="UTF-8">
<title>Add Hotel Room Form</title>
...
<input type="available" name="available" class="form-control" placeholder="Available">
@error('available')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<input type="text" name="per_room_price" class="form-control" placeholder="Per Room Price">
